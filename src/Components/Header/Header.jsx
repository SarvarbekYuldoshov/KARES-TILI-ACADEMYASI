  ...
  return (
    <div className="header">
      <div className="container header-container">
        <ul className="header-list header-list-a">
          <img className="header-img" src={Rasm_1} alt="" />
          <p className="header-text">{t('header.header_text')}</p>
        </ul>
        <ul className="header-list">
          <li className="header-item">
            <a className="header-link" href="">{t('header.header_link_1')}</a>
          </li>
          <li className="header-item">
            <a className="header-link" href="">{t('header.header_link_2')}</a>
          </li>
          <li className="header-item">
            <a className="header-link" href="">{t('header.header_link_3')}</a>
          </li>
          <li className="header-item">
            <a className="header-link" href="">{t('header.header_link_4')}</a>
          </li>
        </ul>
        <ul className="header-list">
